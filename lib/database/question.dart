...
class Question {
  ...
  Question(this._uniqId, this._question,this._answer1,this._answer2,
           this._answer3,this._answer4,this._answer5,this._answer6,
           this._corectAns,this._pageWidget);
