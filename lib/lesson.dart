...
class Lesson {
  ...
  QuestionCategory1 currentQuestion;
   ...
   var qeu =new QuestionCategory1(2,"QB2","b1","b2","b3","b4","b5","b6","BAns", "QuestionTypeB");
 ...
 //QustionList newList;
  ...
  Lesson(){
       // this.q=  new QuestionCategory1(1,"Q","a1","a2","a3","a4","a5","a6","Ans", true,QuestionTypeA());
        ...
        dataHelper.initDB();
       dataHelper.saveQuestion(q);
       dataHelper.saveQuestion(q1);
    //    dataHelper.saveQuestion(qeustion);
