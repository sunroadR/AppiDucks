...
class QuestionTypeE extends StatefulWidget {
  ...
  QuestionTypeE(Question question, Lesson lesson, User user) {
  ...
  State<StatefulWidget> createState() {
    ...
    return _QuestionTypeE();
  }
}

class _QuestionTypeE extends State<QuestionTypeE>{
           ...
           shadowColor: Colors.lightBlueAccent.shade100,
                ...
                child: MaterialButton(
                  ...
                  onPressed: () {
                    ...
                    print('trykket answer alternativ Deet er denne =???');
                    if (widget.question.firstTime== 'true') {
                      print('trykket answer alternativ innne  i if?');
                      setState(() {
